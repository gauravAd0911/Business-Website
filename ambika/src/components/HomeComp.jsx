  ...
  >
    ...
    <div className="container mx-auto flex flex-col md:flex-row items-center justify-center relative z-10">
      ...
      <div className=" caveat-custom  md:w-1/2 text-center">
        ...
        <a href="/contact" className="inline-flex items-center text-2xl bg-orange-500 text-white font-bold px-6 py-3 rounded-lg hover:bg-yellow-600 transition-all duration-300 ease-in-out">
      Contact Us
